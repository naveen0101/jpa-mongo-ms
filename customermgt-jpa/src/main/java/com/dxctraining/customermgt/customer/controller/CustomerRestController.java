...
public class CustomerRestController {
	...
	public CustomerDto create(@RequestBody CreateCustomerRequest data) {
		Customer customer = new Customer(data.getCustName());
	...
	public CustomerDto findByName(@PathVariable("custname") String custname) {
		List<Customer> customer = service.findByCustName(custname);
